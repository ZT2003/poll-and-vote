...
<body>
    ...
    <div class="search" style="display:none;">
        ...
        <div class="categories">
            ...
            <a href="index.php?filter=SPORTS">SPORTS</a>
            <a href="index.php?filter=ART">ART</a>
            <a href="index.php?filter=TRAVEL">TRAVEL</a>
            <a href="index.php?filter=FOOD">FOOD</a>
            <a href="index.php?filter=MOVIES">MOVIES</a>
            <a href="index.php?filter=EDUCATION">EDUCATION</a>
            <a href="index.php?filter=BOOKS">BOOKS</a>
            <a href="index.php?filter=VIDEO GAMES">VIDEO GAMES</a>
            <a href="index.php?filter=TECHNOLOGY">TECHNOLOGY</a>
            <a href="index.php?filter=GENERAL">GENERAL</a>
            <a href="index.php?status=active">ACTIVE</a>
            <a href="index.php?status=inactive">INACTIVE</a>
        </div>
        <hr>
    </div>
